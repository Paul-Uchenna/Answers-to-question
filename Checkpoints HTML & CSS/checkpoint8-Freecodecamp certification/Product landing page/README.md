...
You can build your project using VS code. Or you can use this CDN link to run the tests in any environment you want: https://cdn.freecodecamp.org/testable-projects-fcc/v1/bundle.js
